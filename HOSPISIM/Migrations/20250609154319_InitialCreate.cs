        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoSanguineo = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Telefone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    RegistroConselho = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MotivoInternacao = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Leito = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Quarto = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Setor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PlanoSaudeUtilizado = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ObservacoesClinicas = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    StatusInternacao = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusPrescricao = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ReacoesAdversas = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CondicaoPaciente = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
